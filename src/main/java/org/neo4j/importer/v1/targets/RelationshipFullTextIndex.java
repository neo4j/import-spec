...
public class RelationshipFullTextIndex extends Index {
    private final List<String> properties;
    private final Map<String, Object> options;

    @JsonCreator
    public RelationshipFullTextIndex(
    ...
    public boolean equals(Object o) {
        ...
        RelationshipFullTextIndex that = (RelationshipFullTextIndex) o;
    ...
    public String toString() {
        return "RelationshipFullTextIndex{" + "properties="
                + properties + ", options="
                + options + "} "
                + super.toString();
    }
