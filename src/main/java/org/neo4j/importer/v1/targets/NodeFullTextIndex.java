...
public class NodeFullTextIndex extends Index {
    ...
    public boolean equals(Object o) {
        ...
        NodeFullTextIndex that = (NodeFullTextIndex) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), labels, properties, options);
    }

    @Override
    public String toString() {
        return "NodeFullTextIndex{" + "labels="
                + labels + ", properties="
                + properties + ", options="
                + options + "} "
                + super.toString();
