...
public class RelationshipKeyConstraint extends Constraint {

    private final List<String> properties;
    private final Map<String, Object> options;

    @JsonCreator
    public RelationshipKeyConstraint(
    ...
    public boolean equals(Object o) {
        ...
        RelationshipKeyConstraint that = (RelationshipKeyConstraint) o;
    ...
    public String toString() {
        return "RelationshipKeyConstraint{" + "properties="
                + properties + ", options="
                + options + "} "
                + super.toString();
    }
