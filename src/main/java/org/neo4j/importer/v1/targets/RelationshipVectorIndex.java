...
public class RelationshipVectorIndex extends Index {
    private final String property;
    private final Map<String, Object> options;

    @JsonCreator
    public RelationshipVectorIndex(
    ...
    public boolean equals(Object o) {
        ...
        RelationshipVectorIndex that = (RelationshipVectorIndex) o;
    ...
    public String toString() {
        return "RelationshipVectorIndex{" + "property='"
                + property + '\'' + ", options="
                + options + "} "
                + super.toString();
    }
