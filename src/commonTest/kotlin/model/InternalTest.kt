...
class InternalTest {
    ...
    fun `test increments IDs correctly for multiple nodes and children`() {
        val model = GraphModel(
            ...
            nodes = mutableMapOf(
                "User1" to Node(
                    constraints = mutableMapOf("c1" to NodeConstraint(
    ...
    fun `test translates mappings and deep properties correctly`() {
        ...
        assertTrue(relMapping.properties.containsKey("relationshipProperty0"), "Relationship property should be renamed")
