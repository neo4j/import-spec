...
public class NoActionValidator implements SpecificationValidator {

    private static final String ERROR_CODE = "GTNA-001";
    ...
    public boolean report(Builder builder) {
        if (invalid.get()) {
            builder.addError("$.actions", ERROR_CODE, "Graph type cannot be generated: actions are not supported");
        }
        return false;
    }
}
