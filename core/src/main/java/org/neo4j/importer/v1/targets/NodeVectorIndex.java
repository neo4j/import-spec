...
public class NodeVectorIndex extends Index {
    private final String property;
    private final Map<String, Object> options;

    @JsonCreator
    public NodeVectorIndex(
    ...
    public boolean equals(Object o) {
        ...
        NodeVectorIndex that = (NodeVectorIndex) o;
    ...
    public String toString() {
        return "NodeVectorIndex{" + "property='" + property + '\'' + ", options=" + options + "} " + super.toString();
    }
}
