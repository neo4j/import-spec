...
public class RelationshipTextIndex extends Index {
    private final String property;
    private final Map<String, Object> options;

    @JsonCreator
    public RelationshipTextIndex(
    ...
    public boolean equals(Object o) {
        ...
        RelationshipTextIndex that = (RelationshipTextIndex) o;
    ...
    public String toString() {
        return "RelationshipTextIndex{" + "property='"
                + property + '\'' + ", options="
                + options + "} "
                + super.toString();
    }
