...
public class NoDanglingLabelInVectorIndexValidator implements SpecificationValidator {

    private static final String ERROR_CODE = "DANG-021";

    private final Map<String, String> invalidPaths;

    public NoDanglingLabelInVectorIndexValidator() {
